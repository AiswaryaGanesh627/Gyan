...
public class MquestActivity extends AppCompatActivity {
    String qnum;
    int q_number,val;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question=findViewById(R.id.et_question1);
        opt1=findViewById(R.id.et_opt11);
        opt2=findViewById(R.id.et_opt21);
        opt3=findViewById(R.id.et_opt31);
        opt4=findViewById(R.id.et_opt41);
        correct=findViewById(R.id.et_correct1);
        next=findViewById(R.id.btn_next1);
        ...
        if(val!=0) {
            ...
            next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (i < (val - 1)) {
                        ...
                        db.collection("MonthlyQuest").document(String.valueOf(java.time.ZonedDateTime.now().getMonth()))
                                .set(map)
                        ...
                        startActivity(new Intent(MquestActivity.this, ThankActivity.class));
            ...
            cancel.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    map.clear();
                    startActivity(new Intent(MquestActivity.this, AdpersonalActivity.class));
